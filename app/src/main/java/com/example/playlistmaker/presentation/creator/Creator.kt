...
object Creator {
    ...
    fun provideThemeInteractor(context: Context): ThemeInteractor {
        val sharedPreferences = context.getSharedPreferences("AppPreferences", Context.MODE_PRIVATE)
        val sharedPreferencesHelper = SharedPreferencesHelper(sharedPreferences, gson)
        val themeRepository: ThemeRepository = ThemeRepositoryImpl(sharedPreferencesHelper)
